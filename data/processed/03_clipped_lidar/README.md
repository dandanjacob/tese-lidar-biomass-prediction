...
> ⚠️ **Atenção (auditoria 2026-06-04):** estes clips têm problemas conhecidos —
> parcelas com `Name` repetido no KML têm o recorte feito sobre apenas uma
> sub-parcela (clip incompleto), e o conjunto está dessincronizado da versão
> atual das interseções (274 clips × 254 parcelas). **Precisam ser regerados.**
